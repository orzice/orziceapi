...
if (!function_exists('getServerIp')) {
    function getServerIp() {
      if(config_plus("orzice.ServerIp") && config_plus("orzice.ServerIp") !== '') {
        return config_plus("orzice.ServerIp");
      } else {
        return getIp();
      }
    }
...
if (!function_exists('getpwSDK')) {
    function getpwSDK() {
      if(config_plus("orzice.pwSDK") && config_plus("orzice.pwSDK") !== '') {
        return config_plus("orzice.pwSDK");
      } else {
        return str_rand(12);
      }
    }
...
if (!function_exists('getuserPW')) {
    function getuserPW() {
      if(config_plus("orzice.userPW") && config_plus("orzice.userPW") !== '') {
        return config_plus("orzice.userPW");
      } else {
        return str_rand(12);
      }
    }
...
if (!function_exists('getAdmin')) {
    function getAdmin() {
      if(config_plus("orzice.Admin") && config_plus("orzice.Admin") !== '') {
        return config_plus("orzice.Admin");
      } else {
...
if (!function_exists('getuniqueid')) {
    function getuniqueid() {
      if(config_plus("orzice.uniqueid") && config_plus("orzice.uniqueid") !== '') {
        return config_plus("orzice.uniqueid");
      } else {
...
if (!function_exists('Sessions')) {
    ...
    {
        $src = config_plus("orzice.SessionName");
        if($name){
            $src = $src .".".$name;
        }
        if($data !== 0){
...
if (!function_exists('__aurl')) {
    ...
    {
        return __url(config_plus("orzice.Admin").'/index/index').'#'.__url($url);
...
if (!function_exists('U_password')) {
    ...
    {
        $value = sha1('orzice_') . md5(config_plus("orzice.userPW")) .  md5($value) . sha1($value);
        return sha1($value);
    }
