...
<head>
    ...
    <title><?=$lang['An error occurred']?> - OrziceApi</title>
...
<div class="content-container">
    ...
    <div class="buttons-container">
        <a href="/"><?=$lang['Home']?></a>
        <a href="https://github.com/orzice/orziceapi" target="_blank"><?=$lang['Feedback']?></a>
    </div>
    <div >
        <p style="font-size: 14px;margin: 20px 0;padding: 10px 0;font-weight: 400;">
            开源项目 <a href="https://github.com/orzice/orziceapi" target="_blank" class="">OrziceApi</a> 驱动
        </p>
    </div>
</div>
</body>
